    ...
    return (
        ...
        <Card>
            ...
            <div className='left'>
                ...
                <div className='likeContainer'><i className='fas fa-heart'><p style={{fontFamily:'Montserrat, san-serif'}}>{post.totalLikes}</p></i><i class="fas fa-comment comment"><p style={{fontFamily:'Montserrat, san-serif'}}>{post.comments.length}</p></i>
                </div>
            </div>
            <div className='right'>
